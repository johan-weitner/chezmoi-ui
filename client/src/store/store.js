...
const rootSlice = createSlice({
	...
	reducers: {
		...
		setAppCollection: (state, action) => {
			state.appCollection = action.payload;
		},
		setAppGroups: (state, action) => {
		...
		setInReverse: (state, action) => {
			state.inReverse = action.payload;
		},
		...
		setSelectedAppTags: (state, action) => {
			state.selectedAppTags = action.payload;
		},
		setSelectedAppGroups: (state, action) => {
			state.selectedAppGroups = action.payload;
		},
		setSelectedGroup: (state, action) => {
			state.selectedGroup = action.payload;
		},
		setSelectedGroupKey: (state, action) => {
			state.selectedGroupKey = action.payload;
		},
		setSelectedGroupId: (state, action) => {
			state.selectedGroupId = action.payload;
		},
		setAllowedTags: (state, action) => {
			state.allowedTags = action.payload;
		},
		setEditMode: (state, action) => {
			state.editMode = action.payload;
		},
		setIsNewApp: (state, action) => {
			state.isNewApp = action.payload;
		},
